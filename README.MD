...
6. In your terminal/cmd run `java -jar -Dtelegram.secret.key=MySecretKeyFromStep6 target/simpleBot-1.0-SNAPSHOT-jar-with-dependencies.jar`
...
[[ee](https://www.evernote.com/l/ABGzCzHt_wBFfpmLBLk1Cap6j1rkGR434tY)]
